...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "stocks", "spotlight", "signals", "compare", "rankings", "industries", "themes", "dividends", "benefits", "earnings", "brokers", "videos", "learn", "paths", "glossary", "experts", "about"];
